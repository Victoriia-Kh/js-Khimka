...
document.write("Початковий масив: " + "         " + cars + "</br>");
var elem = prompt("Після якого елемента?", '');
var dodatElem = prompt('Який елемент додати?', '');

var nayshly = false

for (var i = 0; i <= cars.length; i++) {
    if (cars[i] == elem){
        cars.splice(i+1, 0, dodatElem);
        break;
    }
    if (i == cars.length) {
        cars.push(dodatElem);
...
document.write("Масив після цієї операції: " + cars + "</br>");