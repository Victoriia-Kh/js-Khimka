...
6. Используя конструкцию if..else, напишите код, который получает число через prompt, 
...
console.log("Введіть логін");
var login = prompt('Введіть логін','ввід');
if (login == '' || login == null) {
    alert("Отменено");
} else if (login != "Админ") {
    alert("Я вас не знаю");
} else {
    parol = prompt("Введіть пароль");
    if (parol == null) {
        alert("Отменено");
